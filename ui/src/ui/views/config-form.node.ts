...
export function renderNode(params: {
  ...
  if (unsupported.has(key)) {
    return html`<div class="cfg-field cfg-field--error">
      ...
      <div class="cfg-field__error">${t().config.form.schemaUnsupported}</div>
    </div>`;
  }
  ...
  return html`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${label}</div>
      <div class="cfg-field__error">${t().config.form.unsupportedType}: ${type}. ${t().config.form.useRawMode}</div>
    </div>
  `;
}
  ...
  return html`
    <div class="cfg-array">
      <div class="cfg-array__header">
        ...
        <span class="cfg-array__count">${arr.length} ${arr.length === 1 ? t().config.form.item : t().config.form.items}</span>
        <button
          type="button"
